...
![The finished walkthrough visual in Power BI: a "Sales by Country" heading above a styled list of countries and sales values, with cross-filtering enabled.](./images/pbir-guide/pbir-final-result.svg "The finished walkthrough visual, assembled entirely through PBIR.")
