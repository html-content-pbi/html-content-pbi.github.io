---
sidebar_position: 90
description: Current contributors for HTML Content.
slug: /contributors
---
...
<div class="profile-section">
  <div>
    ...
    >
      <img
        src={require("@site/static/img/dm-p-2026-07.png").default}
        height="200px"
      />
    </a>
  </div>
...
In addition to working on the HTML Content family of visuals, Daniel [contributes a number of free and open-source custom visuals](https://appsource.microsoft.com/en-us/marketplace/apps?search=marsh-patrick&page=1&product=power-bi-visuals) to the Power BI Marketplace.
